...
#ifndef _KINGCOINRPC_H_
#define _KINGCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // KingCoin is not connected
...
/**
 * KingCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
