...
#ifndef KINGCOIN_MAIN_H
#define KINGCOIN_MAIN_H
...
static const int64 MIN_MINT_PROOF_OF_WORK = 1 * COIN;
...
static const uint256 hashGenesisBlockOfficial("0x00000b870f3a1ce7080b1f32d300dd9a21eb345955274a5ca439719bd09328a4");
...
public:
    ...
    */
    ...
    /** Amount of kingcoins spent by this transaction.
    ...
    /** Amount of kingcoins coming in to this transaction
...
public:
    ...
    uint256 GetHash() const
    {
        ...
        scrypt_hash(CVOIDBEGIN(nVersion), sizeof(block_header), UINTBEGIN(thash), CalculateN(nTime));
    ...
    {
        // Protocol switch to support p2pool at kingcoin block #9689
//        if (nHeight >= 9689)
        {
...
/*        // Before kingcoin block #9689 - old protocol
