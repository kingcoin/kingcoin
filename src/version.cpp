...
// for both kingcoind and KingCoin, to make it harder for attackers to
// target servers or GUI users specifically.


const std::string CLIENT_NAME("KingCoin");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-KING-stable"
